#include "arctos_hardware_interface/arctos_controller.hpp"
...
{
ArctosController::ArctosController() : controller_interface::ControllerInterface() {}

controller_interface::CallbackReturn ArctosController::on_init()
{
...
controller_interface::InterfaceConfiguration ArctosController::command_interface_configuration()
  const
{
...
controller_interface::InterfaceConfiguration ArctosController::state_interface_configuration() const
{
  controller_interface::InterfaceConfiguration conf = {config_type::INDIVIDUAL, {}};
...
controller_interface::CallbackReturn ArctosController::on_configure(const rclcpp_lifecycle::State &)
{
  auto callback =
...
controller_interface::CallbackReturn ArctosController::on_activate(const rclcpp_lifecycle::State &)
{
...
controller_interface::return_type ArctosController::update(
...
controller_interface::CallbackReturn ArctosController::on_deactivate(const rclcpp_lifecycle::State &)
{
  release_interfaces();
...
controller_interface::CallbackReturn ArctosController::on_cleanup(const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn ArctosController::on_error(const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}

controller_interface::CallbackReturn ArctosController::on_shutdown(const rclcpp_lifecycle::State &)
{
  return CallbackReturn::SUCCESS;
}
...
PLUGINLIB_EXPORT_CLASS(
  arctos_hardware_interface::ArctosController, controller_interface::ControllerInterface)
